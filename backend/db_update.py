...
def update_db():
    ...
    try:
        ...
        # 6. AI Scheduling specific additions
        print("Altering projects table for scheduling fields...")
        scheduling_alters = [
        ...
        for stmt in scheduling_alters:
            try:
                cursor.execute(stmt)
                print(f"Executed: {stmt}")
            except Exception as e:
                print(f"Ignored scheduling alter error: {e}")

        print("Creating project_risks table...")
        cursor.execute("""
        ...
        print("Creating resource_suggestions table...")
        cursor.execute("""
